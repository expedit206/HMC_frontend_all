...
const PolitiqueConfidentialite = () =>
  import("../pages/public/PolitiqueConfidentialite.vue");
...
const AdminSupervisionLocation = () =>
  import("../pages/admin/SupervisionLocation.vue");
const AdminDemandesPublication = () =>
  import("../pages/admin/DemandesPublication.vue");
...
const BailleurMesLocataires = () =>
  import("../pages/bailleur/MesLocataires.vue");
const BailleurInterventions = () =>
  import("../pages/bailleur/Interventions.vue");
...
const BailleurDevenirPrestataire = () =>
  import("../pages/bailleur/DevenirPrestataire.vue");
const BailleurFormulaire = () =>
  import("../pages/bailleur/FormulaireBailleur.vue");
...
const LocataireMesLocations = () =>
  import("../pages/locataire/MesLocations.vue");
const MesFavoris = () => import("../pages/shared/MesFavoris.vue");
const LocataireInterventions = () =>
  import("../pages/locataire/Interventions.vue");
const LocataireMesPaiements = () =>
  import("../pages/locataire/MesPaiements.vue");
const LocataireDetailMonBien = () =>
  import("../pages/locataire/DetailMonBien.vue");
const LocataireFormulaireLocation = () =>
  import("../pages/locataire/FormulaireLocation.vue");
...
const LocatairePaiementFacture = () =>
  import("../pages/locataire/PaiementFacture.vue");
const LocataireRecapitulatifPaiement = () =>
  import("../pages/locataire/RecapitulatifPaiement.vue");

// Prestataire Pages
const PrestataireDashboard = () => import("../pages/prestataire/Dashboard.vue");
const PrestataireServices = () =>
  import("../pages/prestataire/MesServices.vue");
const PrestataireInterventions = () =>
  import("../pages/prestataire/Interventions.vue");
...
const PrestataireAssistance = () =>
  import("../pages/prestataire/Assistance.vue");
const PrestataireInscription = () =>
  import("../pages/prestataire/Inscription.vue");

// Marketplace Pages
const MarketplaceIndex = () => import("../market-place/Index.vue");
const MarketplaceDetail = () => import("../market-place/DetailProduit.vue");
const MarketplaceAdd = () => import("../market-place/AddProduct.vue");
const MarketplaceAide = () => import("../market-place/Aide.vue");
const MarketplaceContact = () => import("../market-place/Contact.vue");

// Vendor Pages
const VendorDashboard = () => import("../market-place/vendor/Dashboard.vue");
const VendorProducts = () => import("../market-place/vendor/MesProduits.vue");
const VendorOrders = () => import("../market-place/vendor/MesCommandes.vue");
const VendorEditProduct = () =>
  import("../market-place/vendor/EditerProduit.vue");
const VendorBoutique = () => import("../market-place/Boutique.vue");
...
const routes = [
  // Public routes
  {
    ...
    children: [
      { path: "/", name: "Accueil", component: Accueil },
      {
        ...
        name: "Annonces",
        component: Annonces,
        meta: { hideFooter: true, noMainScroll: true },
      },
      {
        path: "annonces/:slug",
        name: "DetailAnnonce",
      ...
      {
        path: "programmer-visite",
        name: "ProgrammerVisite",
        component: ProgrammerVisite,
      },
      {
...

      {
        ...
        component: DossierLocation,
      },
      {
        path: "/publier-bien",
        name: "PublierBien",
        component: PublierBien,
        meta: { hasSidebar: true, isFullWidth: false },
      },
      {
        path: "/mes-demandes",
      ...
      // Page Paramètres unifiée (tous rôles confondus)
      {
        path: "/parametres",
        name: "Parametres",
        component: SharedParametres,
        meta: { hasSidebar: true, isFullWidth: false },
      },
      {
        path: "/marketplace/orders",
        name: "MarketplaceOrders",
        component: () => import("../pages/shared/MarketplaceOrders.vue"),
        meta: { hasSidebar: true, isFullWidth: false },
      },
      {
        path: "/messages",
        name: "Messages",
        component: () => import("../pages/shared/Messages.vue"),
        meta: { hasSidebar: true, isFullWidth: false },
      },
    ],
  },
    ...
    children: [
      {
        path: "/feed",
        name: "SocialFeed",
        component: () => import("../pages/public/social/SocialFeed.vue"),
        meta: { hasSidebar: true, showRightSidebar: true },
      },
    ],
  },
  ...
  // Admin routes
  {
    ...
    children: [
      ...
      {
        path: "biens-annonces",
        name: "AdminBiensAnnonces",
        component: AdminBiensAnnonces,
      },
      { path: "finances", name: "AdminFinances", component: AdminFinances },
      { path: "services", name: "AdminServices", component: AdminServices },
      {
        path: "supervision-location",
        name: "AdminSupervisionLocation",
        component: AdminSupervisionLocation,
      },
      {
        path: "demandes-publication",
        name: "AdminDemandesPublication",
        component: AdminDemandesPublication,
      },
    ],
  },
  ...
  // Agent routes
  {
    ...
    children: [
      ...
      { path: "agenda", name: "AgentAgenda", component: AgentAgenda },
      {
        ...
        component: AgentAssistance,
      },
      { path: "formation", name: "AgentFormation", component: AgentFormation },
      {
        path: "inscription",
        name: "AgentInscription",
        component: AgentInscription,
        meta: { hasSidebar: false },
      },
      ...
      {
        path: "statistiques",
        name: "AgentStatistiques",
        component: AgentStatistiques,
      },
      {
        path: "publication-missions/:id/audit",
        name: "AgentPublierBien",
        component: AgentPublierBien,
      },
    ],
  },
  ...
  // Bailleur routes
  {
    ...
    children: [
      {
        path: "dashboard",
        name: "BailleurDashboard",
        component: BailleurDashboard,
      },
      {
        path: "mes-biens",
        name: "BailleurMesBiens",
        component: BailleurMesBiens,
      },
      {
        path: "biens/:id/editer",
        name: "BailleurEditerBien",
        component: BailleurEditerBien,
      },
      {
        path: "mes-locataires",
        name: "BailleurMesLocataires",
        component: BailleurMesLocataires,
      },
      {
        path: "interventions",
        name: "BailleurInterventions",
        component: BailleurInterventions,
      },
      { path: "visites", name: "BailleurVisites", component: BailleurVisites },
      {
        path: "finances",
        name: "BailleurFinances",
        component: BailleurFinances,
      },
      {
        path: "assistance",
        name: "BailleurAssistance",
        component: BailleurAssistance,
      },
      {
        path: "devenir-prestataire",
        name: "BailleurDevenirPrestataire",
        component: BailleurDevenirPrestataire,
        meta: { hasSidebar: false },
      },
      {
        path: "formulaire",
        name: "BailleurFormulaire",
        component: BailleurFormulaire,
        meta: { hasSidebar: false },
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: LocataireDashboard,
      },
      {
        path: "mes-locations",
        name: "LocataireMesLocations",
        component: LocataireMesLocations,
      },
      {
        path: "interventions",
        name: "LocataireInterventions",
        component: LocataireInterventions,
      },
      {
        path: "mes-paiements",
        name: "LocataireMesPaiements",
        component: LocataireMesPaiements,
      },
      {
        path: "detail-mon-bien",
        name: "LocataireDetailMonBien",
        component: LocataireDetailMonBien,
      },
      {
        path: "formulaire-location",
        name: "LocataireFormulaireLocation",
        component: LocataireFormulaireLocation,
        meta: { hasSidebar: false },
      },
      {
        path: "inscription",
        name: "LocataireInscription",
        component: LocataireInscription,
        meta: { hasSidebar: false },
      },
      {
        path: "assistance",
        name: "LocataireAssistance",
        component: LocataireAssistance,
      },
      {
        path: "paiement-facture",
        name: "LocatairePaiementFacture",
        component: LocatairePaiementFacture,
      },
      {
        path: "recapitulatif-paiement",
        name: "LocataireRecapitulatifPaiement",
        component: LocataireRecapitulatifPaiement,
      },
    ],
  },
  ...
  // Prestataire routes
  {
    ...
    children: [
      ...
      {
        path: "mes-services",
        name: "PrestataireServices",
        component: PrestataireServices,
      },
      {
        path: "interventions",
        name: "PrestataireInterventions",
        component: PrestataireInterventions,
      },
      {
        path: "agenda",
        name: "PrestataireAgenda",
        component: PrestataireAgenda,
      },
      {
        path: "finances",
        name: "PrestataireFinances",
        component: PrestataireFinances,
      },
      {
        path: "assistance",
        name: "PrestataireAssistance",
        component: PrestataireAssistance,
      },
      {
        path: "inscription",
        name: "PrestataireInscription",
        component: PrestataireInscription,
        meta: { hasSidebar: false },
      }, // Exclu
    ],
  },
  ...
  // Marketplace routes
  {
    path: "/marketplace",
    component: SocialLayout,
    meta: { hasSidebar: true, isFullWidth: true },
    children: [
      ...
      {
        path: "boutique/:id",
        name: "VendeurBoutique",
        component: VendorBoutique,
      },
      ...
      // Routes Vendeur (Protégées par authOnlyPaths)
      {
      ...
      {
        path: "seller/produits",
        name: "VendeurProduits",
        component: VendorProducts,
        meta: { hasSidebar: true },
      },
      {
        path: "seller/produits/:id/editer",
        name: "VendeurEditerProduit",
        component: VendorEditProduct,
      },
      {
        path: "seller/commandes",
        name: "VendeurCommandes",
  ...
  // Services routes
  {
    ...
    children: [
      {
        path: "demandes",
        name: "MarketplaceDemandes",
        component: DemandesServices,
      },
      {
        path: "demandes/:id",
        name: "ServicePostDetail",
        component: () => import("../pages/services/ServicePostDetail.vue"),
      },
      {
        path: "prestataires",
        name: "MarketplacePrestataires",
...
router.beforeEach(async (to, from, next) => {
  ...
  if (isAuthenticated && to.path.startsWith("/auth")) {
    ...
    switch (userRole) {
      case "admin":
        ...
        break;
      case "bailleur":
        redirectPath = "/bailleur/dashboard";
        break;
      case "locataire":
        redirectPath = "/locataire/dashboard";
        break;
      case "prestataire":
        redirectPath = "/prestataire/dashboard";
        break;
      case "agent":
  ...
  const protectedPrefixes = [
    { prefix: "/admin", role: "admin" },
    {
      prefix: "/bailleur",
      role: "bailleur",
      excludes: ["/bailleur/formulaire"],
    },
    {
      prefix: "/locataire",
      role: "locataire",
      excludes: ["/locataire/formulaire-location", "/locataire/inscription"],
    },
    {
      prefix: "/prestataire",
      role: "prestataire",
      excludes: ["/prestataire/inscription"],
    },
  ...
  const matchedProtection = protectedPrefixes.find((p) => {
    ...
    if (p.excludes && p.excludes.some((ex) => to.path.startsWith(ex)))
      return false;
    return true;
  });
