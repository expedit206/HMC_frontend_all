  ...
  <DashboardLayout>
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div
            class="w-12 h-12 rounded-xl bg-green-50 text-green-500 flex items-center justify-center text-xl"
          >
      ...
      >
        <div
          class="w-12 h-12 border-4 border-[#E54801] border-t-transparent rounded-full animate-spin mb-4"
        ></div>
        <p
      ...
      <div v-else class="space-y-4">
        ...
        >
          ...
          >
            ...
            <!-- Agent Info -->
            <div
              class="bg-gray-50/50 p-4 rounded-2xl border border-gray-100/50 flex items-center gap-4 min-w-[240px]"
            >
              ...
              <div v-else class="flex flex-col">
                <p
                  class="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none mb-2"
                >
                  Agent Responsable
                </p>
                <div
            ...
            >
              ...
              >
                <p
                  class="text-[9px] font-black text-blue-500 uppercase tracking-widest leading-none mb-1 text-right"
                >
                  📅 RDV Audit Terrain
                </p>
