  ...
  <DashboardLayout>
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <template v-else>
          ...
          >
            <div
              class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-3"
            >
              <div
          ...
          <div v-if="auditMissions.length > 0" class="mb-10 animate-fadeIn">
            <div class="flex items-center justify-between mb-4">
              <h2
                class="text-lg font-black text-[#1B0B38] flex items-center gap-2"
              >
                <span
              ...
              >
                ...
                <div class="p-4">
                  ...
                  <p
                    ...
                    class="text-xs font-bold text-purple-700 mb-3"
                  >
          ...
          <div class="animate-fadeIn">
            <div class="flex items-center justify-between mb-4">
              ...
              >
                <span
                  class="w-2 h-5 bg-[#E54801] rounded-full inline-block"
                ></span>
                Biens publiés &amp; gérés
              </h2>
              ...
              >
                ...
                <div class="p-4">
                  <div class="flex justify-between items-start mb-1">
                    <span
                      class="text-[10px] font-black text-[#E54801] uppercase tracking-wider"
                  ...
                  <p class="text-xs text-gray-500 mb-3 flex items-center gap-1">
                    <i
                      class="fas fa-map-marker-alt text-gray-400 text-[10px]"
                    ></i>
                  ...
                  <!-- Stats -->
                  <div
                    class="flex items-center gap-3 text-xs text-gray-400 border-t border-gray-50 pt-3"
                  >
                    ...
                    >
                    <span
                      class="ml-auto flex items-center gap-1 text-[#E54801]"
                    >
