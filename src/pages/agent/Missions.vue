  ...
  <DashboardLayout>
    <div class="max-w-7xl mx-auto h-full">
      ...
      >
        ...
        >
          <div
            class="w-12 h-12 rounded-xl bg-orange-50 text-[#E54801] flex items-center justify-center text-xl"
          >
            <i class="fas fa-calendar-check"></i>
          </div>
          <div>
            <p
              class="text-gray-400 text-xs font-black uppercase tracking-widest"
            >
              Visites à valider
            </p>
      ...
      <div v-if="isLoading" class="py-20 text-center">
        <div
          class="w-12 h-12 border-4 border-[#E54801]/20 border-t-[#E54801] rounded-full animate-spin mx-auto mb-4"
        ></div>
          ...
          <div v-else class="space-y-4">
            ...
            >
              ...
              >
                ...
                <div
                  class="text-right w-full md:w-auto bg-gray-50 p-3 rounded-xl border border-gray-100"
                >
                  <p
                    class="text-[10px] text-gray-400 uppercase font-black tracking-wider mb-1"
                  >
                    Profil postulant
                  </p>
              ...
              <div
                class="flex flex-col sm:flex-row gap-3 mt-4 pt-4 border-t border-gray-50"
              >
                <button
              ...
              >
                <h5
                  class="text-xs font-black text-blue-800 mb-3 flex items-center gap-1"
                >
                ...
                <div
                  v-if="validateError"
                  class="mt-2 text-xs text-red-600 font-bold flex items-center gap-1"
                >
                  <i class="fas fa-exclamation-triangle"></i>
                  {{ validateError }}
                </div>
              ...
              >
                <label class="block text-xs font-bold text-red-800 mb-2"
          ...
          <div v-else class="space-y-4">
            ...
            >
              ...
              <div class="w-full md:w-auto mt-2 md:mt-0">
                ...
                <p
                  class="text-[10px] text-center text-gray-400 mt-2 max-w-[200px]"
                >
        ...
        <div v-if="activeTab === 'audit'" class="animate-fadeIn">
          ...
          <div v-else class="space-y-4">
            ...
            >
              ...
              <!-- Action -->
              <div
                class="border-t border-gray-50 px-5 py-3 bg-gray-50/50 flex justify-between items-center gap-2"
              >
                <div class="flex gap-2">
                  <button
                    v-if="
              ...
              >
                <h4
                  class="text-sm font-black text-blue-800 mb-4 flex items-center gap-2"
                >
              ...
              <div
                ...
                class="border-t-2 border-purple-200 bg-purple-50/30 p-5"
              >
                <h4
                  class="text-sm font-black text-purple-800 mb-4 flex items-center gap-2"
                >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div class="sm:col-span-2">
                    ...
                    >
                      <i
                        class="fas fa-cloud-upload-alt text-purple-300 text-3xl mb-2"
                      ></i>
                      <p class="text-xs text-gray-500">
