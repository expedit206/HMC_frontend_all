      ...
      <div class="max-w-6xl mx-auto">
        ...
        >
          ...
          <div class="flex gap-2" v-if="favorites.length > 0">
            <span
              class="px-5 py-2.5 bg-[#E54801]/10 text-[#E54801] rounded-xl text-xs font-bold uppercase"
              >{{ favorites.length }}
              {{
                favorites.length > 1
                  ? "Favoris Enregistrés"
            ...
            >
              ...
              <div class="p-6">
                <div class="flex justify-between items-start mb-2">
                  <h3
                    class="text-base font-bold text-[#1B0B38] leading-tight line-clamp-1"
                  >
                    {{ fav.property?.title }}
                  </h3>
                ...
                <p
                  class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-4"
                >
                  <i class="fas fa-map-marker-alt text-[#E54801] mr-1"></i>
                  {{ fav.property?.location }}
                </p>
                <div
                  class="flex items-center gap-4 text-xs text-gray-500 font-medium mb-6 pt-4 border-t border-gray-50"
                >
                  <span
                    ><i class="fas fa-bed text-[#E54801] mr-1"></i>
                    {{ fav.property?.bedrooms || 0 }}</span
                  >
                  <span
                    ><i class="fas fa-bath text-[#E54801] mr-1"></i>
                    {{ fav.property?.bathrooms || 0 }}</span
                  >
                  <span
                    ><i class="fas fa-ruler-combined text-[#E54801] mr-1"></i>
        ...
        <div
          v-else
          class="bg-white rounded-3xl p-20 text-center border border-dashed border-gray-200"
        >
          <div
          ...
          <h3
            class="text-2xl font-black text-[#1B0B38] uppercase tracking-tight"
          >
            Aucun favori pour l'instant
          </h3>
          <p
            class="text-gray-400 mt-4 max-w-sm mx-auto font-medium leading-relaxed"
          >
